...
<link href="/modules/addons/TrustOceanSSLAdmin/assets/css/adminarea.css" rel="stylesheet">
...
<script type="text/javascript">
    ...
    jQuery(document).ready( function () {ldelim}
        ...
        var table = jQuery("#CertificateTable").DataTable({ldelim}
            ...
            //"bProcessing": true,
            "ajax":{
                'url':"addonmodules.php?module=TrustOceanSSLAdmin&action=getCertificateList&status={$smarty.get.cat}",
                'type':'POST'
            },
            "oLanguage": {ldelim}
