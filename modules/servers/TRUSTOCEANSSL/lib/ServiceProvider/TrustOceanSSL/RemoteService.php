<?php
namespace WHMCS\Module\Server\TRUSTOCEANSSL\ServiceProvider\TrustOceanSSL;

use WHMCS\Module\Server\TRUSTOCEANSSL\ServiceProvider\TrustOceanSSL\Exception as TrustOceanException;
use WHMCS\Module\Server\TRUSTOCEANSSL\ServiceProvider\TrustOceanSSL\Model\Order;

class RemoteService extends Order
{
     ...
     */
    public function getService($orderId = NULL){
        if(!empty($orderId)){
     ...
     * @throws TrustoceanException
     */
    public function changeDcvMethod($domainName, $newMethod){
        if($domainName == ""){
     ...
     * @throws TrustoceanException
     */
    public function resendDcvEmails(){
        $requestParam = [
            'trustocean_id' =>  $this->order_id
        ];
        $this->callTrustOceanAPI('reTryDcvEmailOrDCVCheck', $requestParam);
     ...
     * @throws TrustoceanException
     */
    public function getDomainValidationDetails(){
        $requestParam = [
            'trustocean_id' =>  $this->order_id
        ];
     ...
     * @throws TrustoceanException
     */
    public function revoke($revocationReason){
        if($revocationReason == ""){
