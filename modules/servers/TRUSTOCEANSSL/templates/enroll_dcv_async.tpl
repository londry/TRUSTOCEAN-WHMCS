                    ...
                    <table id="tableDCVDomainList" data-serviceid="{$serviceid}" class="table to-dcv-table">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="3" colspan="2" style="text-align: left;"><span><span>{$MODLANG.trustoceanssl.enroll.setup3.table.method}</span><span class="sorting-arrows"></span></span></th>
                            </tr>
                        </thead>
                        <tbody>
