...
<div class="section" style="text-align: left !important;">
    <div class="section-header">
        <h3 style="padding-left: 32px;"><i class="fa fa-cog fa-spin" data-glyph="aperture" style="margin-left: -33px;margin-top: 2px; position: absolute; padding-bottom: 0px;"></i> 正在对您提交的企业信息进行预验证</h3>
        ...
        <table>
            <tbody>
                ...
                <tr role="row">
                    <td>联系电话</td>
                    <td style="padding-bottom: 10px; padding-top: 20px;">{$vars.orginfo.organization_phone}<p style="color: #2196F3 !important;">
                            请您将企业名称、地址和联系电话（{$vars.orginfo.organization_phone}）登记到下列公开数据库中的任意一个, 并确保生效可查询
                            <br>
                            <ul style="color: #2196F3 !important;">
                                <li>天眼查 - www.tianyancha.com （登记免费, 1-7工作日可完成可查）</li>
                                <li>百度地图 - map.baidu.com （登记免费, 1-7工作日可完成可查）</li>
                                <li>国家企业信用信息公示系统 - www.gsxt.gov.cn （查询快速, 可用年报信息）</li>
        ...
        <p style="margin-top: 20px;">
            <a href="/submitticket.php" target="_blank" class="btn btn-info btn-checkout"><i class="fas fa-ticket ls ls-new-window"></i> 提交工单</a>
        </p>
    </div>
</div>